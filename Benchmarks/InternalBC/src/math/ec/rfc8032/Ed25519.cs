...
namespace Org.BouncyCastle.Math.EC.Rfc8032
{
    ...
    public static class Ed25519
    {
...
#if NETCOREAPP2_1_OR_GREATER || NETSTANDARD2_1_OR_GREATER
        public static bool DecodePointVar(ReadOnlySpan<byte> p, bool negate, ref PointAffine r)
#else
        public static bool DecodePointVar(byte[] p, bool negate, ref PointAffine r)
#endif
        {
        ...
        public static void EncodePoint(ref PointAffine p, byte[] r, int rOff)
        {
            F.Encode(p.y, r, rOff);
        ...
        public static void Init(out PointAccum r)
        {
            r.x = F.Create();
            r.y = F.Create();
            r.z = F.Create();
...
#if NETCOREAPP2_1_OR_GREATER || NETSTANDARD2_1_OR_GREATER
        public static void ScalarMult(ReadOnlySpan<byte> k, ref PointAffine p, ref PointAccum r)
#else
